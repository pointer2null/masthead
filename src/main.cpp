...
struct I2cData {
    ...
    //    float volts; // voltage from the direction sensor 4 bytes
};
...
void sendData()
{
    ...
    // need to set the wind direction volts
    // txData.volts = analogRead(windVoltsPin);
    Wire.write((byte*)&txData, sizeof(txData));
    // Serial.print("Volts:");
    // Serial.print(txData.volts);
    Serial.print("Count:");
